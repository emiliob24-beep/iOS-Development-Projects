...
//firstRun = RunningWorkout(distance: 2_936, time: 15.3, elevation: 94)
firstRun.distance = 2_936
firstRun.time = 15.3
firstRun.elevation = 94
print("During my run this morning, I ran \(firstRun.distance) meters in \(firstRun.time) minutes and gained \(firstRun.elevation) meters of elevation")
