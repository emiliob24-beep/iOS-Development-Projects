...
//let area = rectangle.areaOfRectangle()
//print(area)
...
struct Height {
    var heightInInches: Double {
        didSet {
            let expectedCentimeterValue = heightInInches * 2.54
            if heightInCentimeters != expectedCentimeterValue {
                heightInCentimeters = expectedCentimeterValue
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let expectedInchesValue = heightInCentimeters / 2.54
            if heightInInches != expectedInchesValue {
                heightInInches = expectedInchesValue
            }
        }
    }
...
var myKidsHeight = Height(heightInInches: 24)
myKidsHeight.heightInInches = 36

//print(myKidsHeight.heightInCentimeters)
