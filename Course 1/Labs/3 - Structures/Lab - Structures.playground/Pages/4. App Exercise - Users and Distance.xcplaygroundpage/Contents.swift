...
var emilio = User(name: "Emilio", age: 23, height: 6, weight: 190, activityLevel: 8)
print("\(emilio.name) is \(emilio.age) years old. He is \(emilio.height) feet tall and weights \(emilio.weight) lbs. On a scale of 1-10, his activity level would be an \(emilio.activityLevel)." )
/*:
...
var shortDistance = Distance(feet: 100)
print(shortDistance.meters)
print(shortDistance.feet) 
