...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    let percentTimeCompleted = currentTime / goalTime
    
    if percentDistance >= percentTimeCompleted {
        print("Keep it up!")
    } else {
...
pacing(currentDistance: 2.5, totalDistance: 5.0, currentTime: 12.5, goalTime: 20.0)
/*:
